...
pythonGenerator.forBlock['celu'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
...
pythonGenerator.forBlock['elu'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
...
pythonGenerator.forBlock['hard_sigmoid'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
...
pythonGenerator.forBlock['hard_silu'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
...
pythonGenerator.forBlock['Embed'] = function(block, generator) {
    ...
    const variableName = block.getFieldValue( 'VAR') ;
    let code = `nn.Embed(${params})(${variableName})\n`;

    if(variableName===""){
        code = `nn.Embed(${params})\n`;
    }
    return [code, Order.ATOMIC];
...
pythonGenerator.forBlock['switch'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR');
...
pythonGenerator.forBlock['reshape'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const variableName2 = block.getFieldValue( 'VAR2') ;
    const variableName3 = block.getFieldValue( 'VAR3') ;
    const code = `${variableName}.reshape(${variableName2}.shape[0], ${variableName3})\n`;
    return [code, Order.ATOMIC];
...
pythonGenerator.forBlock['max_pool'] = function(block, generator) {
...
pythonGenerator.forBlock['pool'] = function(block, generator) {
    const windowShapeX = block.getFieldValue('WINDOW_SHAPE_X');
    const windowShapeY = block.getFieldValue('WINDOW_SHAPE_Y');
    const strideX = block.getFieldValue('STRIDE_X');
    const strideY = block.getFieldValue('STRIDE_Y');
...
pythonGenerator.forBlock['BatchNorm'] = function(block, generator) {
    const params = block.getFieldValue('PARAMS');
    const variableName = block.getFieldValue( 'VAR') ;
    let code = `nn.BatchNorm(${params})(${variableName})\n`;

    if(variableName===""){
        code = `nn.BatchNorm(${params})\n`;
    }
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['LayerNorm'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const code = `nn.LayerNorm()(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['GroupNorm'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const code = `nn.GroupNorm()(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['RMSNorm'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const code = `nn.RMSNorm()(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['InstanceNorm'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const code = `nn.InstanceNorm()(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['SpectralNorm'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR');
    const code = `nn.SpectralNorm()(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['WeightNorm'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
...
pythonGenerator.forBlock['dot_product_attention'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const code = `nn.dot_product_attention()(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['dot_product_attention_weights'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const code = `nn.dot_product_attention_weights()(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['make_attention_mask'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
...
pythonGenerator.forBlock['tanh'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const code = `nn.tanh(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['sigmoid'] = function(block, generator) {
    const variableName = block.getFieldValue( 'VAR') ;
    const code = `nn.sigmoid(${variableName})\n`;
    return [code, Order.ATOMIC];

};
pythonGenerator.forBlock['RNN'] = function(block, generator) {
    const units = block.getFieldValue('UNITS')|| "";
