 ...
 *
 * @type {Object}
 * @property {string} type - The type of the block, set to "python_function".
 * @property {string} message0 - The message template for the block's UI.
 * @property {Array} args0 - The arguments for the block.
 * @property {Object} args0[].type - The type of the field/input (e.g., field_input, input_dummy, input_statement).
 * @property {string} args0[].name - The name identifier for the field/input.
 * @property {string} args0[].text - The default text for the input field (only for field_input).
 * @property {string} colour - The color of the block in the Blockly workspace.
 * @property {null} previousStatement - Indicates that this block can be followed by another block.
 * @property {null} nextStatement - Indicates that this block can be preceded by another block.
 * @property {string} tooltip - The tooltip text that appears on hover.
 * @property {string} helpUrl - A URL to more help related to this block.
 */
...
const jax_mean = {
  ...
  "output": null,
  "colour": 230,
  "tooltip": "Return the mean of array elements along a given axis.",
  "helpUrl": ""
};
...
const reshape = {
  'type': 'reshape',
  'message0': 'Flatten tensor %1 with %2 and data %3',
  'args0': [
    {
      'type': 'field_input',
      'name': 'VAR',
...
const batch_norm_layer = {
  "type": "BatchNorm",
  "message0": "Batch Normalization %1 %2",
  'args0': [
    {
      'type': 'field_input',
      'name': 'PARAMS',
...
const DotProductAttentionWeights = {
  "type": "dot_product_attention_weights",
...
export const blocks = Blockly.common.createBlockDefinitionsFromJsonArray([ constant,delta_orthogonal,glorot_normal,glorot_uniform,he_normal,he_uniform,
  ...
  logical_axis_rules,set_logical_axis_rules,get_logical_axis_rules,logical_to_mesh_axes,logical_to_mesh,logical_to_mesh_sharding,with_logical_constraint,with_logical_partitioning,python_loop,string,member,Declaration,cheatblock,jax_mean
]);
