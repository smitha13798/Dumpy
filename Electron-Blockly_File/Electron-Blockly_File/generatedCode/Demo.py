...
PROJECTSRC_PATH = '../projectsrc/projectskeleton2.py'
...
def read_file(file_path):
    ...
    try:
        ...
        start_line, end_line = find_comment_block('../projectsrc/projectskeleton2.py', start_comment, end_comment)

        if start_line is not None and end_line is not None:
            insert_string_at_line('../projectsrc/projectskeleton2.py', code, start_line, end_line,end_comment)
        else:
